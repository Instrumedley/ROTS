...
function(x, y) {
   ...
   x <- sort(x, decreasing = TRUE)		# sort x in decreasing order
   y <- sort(y, decreasing = TRUE)		# sort y in decreasing order
   ...
   z <- sort(c(x, y), decreasing = TRUE)		# sort c(x,y) in decreasing order
